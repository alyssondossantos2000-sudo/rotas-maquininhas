...
import { detectarDocumento } from "../image/documentDetector.js?v=23";
import { corrigirPerspectiva } from "../image/perspectiveCorrection.js?v=23";
import { desenharGirado, canvasParaBlob, calcularCorrecaoAutomatica } from "../image/autoRotate.js?v=23";
import { proximaRotacaoManual } from "../image/manualRotate.js?v=23";
import { talvezMelhorar } from "../image/enhancer.js?v=23";
import { getOcrProvider, warmupOcr } from "../ocr/provider.js?v=23";
import { normalizarResultado } from "../ocr/wordMapper.js?v=23";
import { reconstruirLayout } from "../layout/blockDetection.js?v=23";
import { interpretarDocumento, paraCamposDeOs } from "../interpret/documentInterpreter.js?v=23";
import { renderizarOverlay } from "./overlay.js?v=23";
import { criarControleZoom } from "./zoom.js?v=23";
import { comLog } from "../core/logger.js?v=23";
