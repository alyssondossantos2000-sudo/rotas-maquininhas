...
import { detectarDocumento } from "../image/documentDetector.js?v=28";
import { corrigirPerspectiva } from "../image/perspectiveCorrection.js?v=28";
import { desenharGirado, canvasParaBlob, calcularCorrecaoAutomatica } from "../image/autoRotate.js?v=28";
import { proximaRotacaoManual } from "../image/manualRotate.js?v=28";
import { talvezMelhorar } from "../image/enhancer.js?v=28";
import { getOcrProvider, warmupOcr } from "../ocr/provider.js?v=28";
import { normalizarResultado } from "../ocr/wordMapper.js?v=28";
import { reconstruirLayout } from "../layout/blockDetection.js?v=28";
import { interpretarDocumento, paraCamposDeOs } from "../interpret/documentInterpreter.js?v=28";
import { renderizarOverlay } from "./overlay.js?v=28";
import { criarControleZoom } from "./zoom.js?v=28";
import { comLog } from "../core/logger.js?v=28";
